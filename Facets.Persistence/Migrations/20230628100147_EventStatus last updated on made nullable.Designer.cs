...
namespace Facets.Persistence.Migrations
{
    ...
    [Migration("20230628100147_EventStatus last updated on made nullable")]
    partial class EventStatuslastupdatedonmadenullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Facets.Core.Events.Entites.Event", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Facets.Core.Events.Entites.EventDate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Facets.Core.Events.Entites.EventDate", b =>
                {
                    b.HasOne("Facets.Core.Events.Entites.Event", "Event")
                        .WithMany("EventDates")
