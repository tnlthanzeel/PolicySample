...
namespace Facets.Persistence.Migrations
{
    ...
    [Migration("20230718034017_Updated template place holder seed data")]
    partial class Updatedtemplateplaceholderseeddata
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Facets.Core.Settings.Counters.RegistrationCounter", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Facets.Core.Settings.Passes.PassCategorySettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal>("ForeignerDiscountAmount")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("ForeignerRate")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("LocalDiscountAmount")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("fdc613a3-061d-47fa-bc19-7e179caff73f"),
                            CreatedOn = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            ForeignerDiscountAmount = 0m,
                            ForeignerRate = 0m,
                            IsChargeable = false,
                            LocalDiscountAmount = 0m,
                            LocalRate = 0m,
                            PassCategoryId = new Guid("a7bd59a2-2e3a-4d25-9f7e-7e8fafa174a3")
                        },
                        new
                        {
                            Id = new Guid("70021f76-eb22-484a-a66c-f4ffcea474f8"),
                            CreatedOn = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            ForeignerDiscountAmount = 0m,
                            ForeignerRate = 0m,
                            IsChargeable = false,
                            LocalDiscountAmount = 0m,
                            LocalRate = 0m,
                            PassCategoryId = new Guid("b435dc73-7688-44e1-af8e-d00743b6a2e6")
                        },
                        new
                        {
                            Id = new Guid("f42ef064-0b4e-4600-a6b6-d999d364c74d"),
                            CreatedOn = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            ForeignerDiscountAmount = 0m,
                            ForeignerRate = 0m,
                            IsChargeable = false,
                            LocalDiscountAmount = 0m,
                            LocalRate = 0m,
                            PassCategoryId = new Guid("cdbf712c-5997-40b0-b281-a01a8d592aab")
                        },
                        new
                        {
                            Id = new Guid("d06f02f4-50e0-4b9f-9a4b-c4a4cab10aee"),
                            CreatedOn = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            ForeignerDiscountAmount = 0m,
                            ForeignerRate = 0m,
                            IsChargeable = false,
                            LocalDiscountAmount = 0m,
                            LocalRate = 0m,
                            PassCategoryId = new Guid("9dee9062-8d9e-469c-b9fb-0770348fe4c4")
                        });
                });
            ...
            modelBuilder.Entity("Facets.Core.Settings.Passes.PassCategorySettings", b =>
                {
                    b.HasOne("Facets.Core.Settings.Passes.PassCategory", "PassCategory")
